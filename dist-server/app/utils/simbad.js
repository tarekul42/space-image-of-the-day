 ...
 */
export async function querySimbad(objectName) {
    ...
    try {
        ...
        const otypeDataMatch = text.match(/<TD>(G|PN|HII|Cl|Neb|Gal|GCl|QSO|Sy\d?|Blazar|C_star|Star|SNR)[\w.*]*/i);
        if (otypeDataMatch) {
 ...
 */
export function inferFromExplanation(title, explanation) {
