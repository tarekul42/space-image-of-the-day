import { querySimbad, inferFromExplanation } from '../../utils/simbad.js';
import { extractObjectName } from '../../utils/nasaApi.js';
/**
 ...
 */
export async function enrichApodData(nasaData) {
    let enriched = {
        object_type: 'Unknown',
    ...
    try {
        ...
        if (simbadData.object_type === 'Celestial Object') {
            ...
            enriched = {
                ...
                constellation: simbadData.constellation !== 'Unknown'
        ...
        console.warn('[Enrichment] SIMBAD failed, falling back to text inference:', enrichError.message);
